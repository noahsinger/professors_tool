...
class Admin::SectionsControllerTest < ActionController::TestCase
  cannot_access_actions([:id => 2, :semester_id => 1], {:index => :get, :show => :get, :new => :get, :create => :post, :edit => :get, :update => :put, :destroy => :delete, :section_email => :get, :export_gradebook => :get})
  ...
  test "should export gradebook" do
    get :export_gradebook, :id => sections(:jck1003_section_1).id, :semester_id => sections(:jck1003_section_1).semester_id
    assert_response :success
  end
end
