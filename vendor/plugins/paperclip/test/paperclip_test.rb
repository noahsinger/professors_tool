  ...
  context "An ActiveRecord model with an 'avatar' attachment" do
    ...
    context "that is attr_protected" do
      ...
      should "not assign the avatar on mass-set" do
       ...
       xxx@xxx.xxx = { :other => "I'm set!",
                              :avatar xxx@xxx.xxx }
        
        assert_equal "I'm xxx@xxx.xxx
        assert xxx@xxx.xxx
      end
    ...
    context "with a subclass" do
      ...
      should "be able to use the attachment from the subclass" do
        assert_nothing_raised do
          @subdummy = SubDummy.create(:avatar xxx@xxx.xxx
        end
      end
     ...
     [:content_type4, {:content_type => "image/png"},  nil,        "text.txt"]].each do |args|
      context "with #{args[0]} validations" do
        ...
        context "and a valid file" do
          setup do
           xxx@xxx.xxx = args[2] && File.new(File.join(FIXTURES_DIR, args[2]))
          end
        ...
        context "and an invalid file" do
          setup do
           xxx@xxx.xxx = args[3] && File.new(File.join(FIXTURES_DIR, args[3]))
          end
