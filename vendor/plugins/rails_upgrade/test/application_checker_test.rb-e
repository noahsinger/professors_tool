  ...
  module Upgrading
    class ApplicationChecker
      ...
      def alert(title, text, more_info_url, culprits)
       xxx@xxx.xxx = [text, more_info_url]
       xxx@xxx.xxx = culprits
      end
    end
  end
end
...
class ApplicationCheckerTest < ActiveSupport::TestCase
  def setup
   xxx@xxx.xxx = Rails::Upgrading::ApplicationChecker.new
   xxx@xxx.xxx = Dir.pwd
  ...
  def test_check_ar_methods_in_controller
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx ActiveRecord calls")
  end
  ...
  def test_check_validation_on_methods
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx syntax for validate_on_* methods")
  end
  ...
  def test_check_before_validation_on_methods
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx syntax for before_validation_on_* methods")
  end
  ...
  def test_check_for_old_test_help_doesnt_see_test_helper
   ...
   xxx@xxx.xxx
    ...
    assert xxx@xxx.xxx test_help path")
  end

  def test_check_lack_of_app_dot_rb
   xxx@xxx.xxx

    xxx@xxx.xxx file needed: config/application.rb")
  end
  ...
  def test_check_gems
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx gem bundling (config.gems)")
  end
  
  def test_check_gems_finds_nothing
   xxx@xxx.xxx

    assert_equal xxx@xxx.xxx gem bundling (config.gems)")
  end
  
  def test_check_mailer_finds_nothing
   xxx@xxx.xxx

    assert_equal xxx@xxx.xxx ActionMailer class API")
  end

  def test_check_mailer_syntax
    make_file("app/models/", "notifications.rb", "def xxx@xxx.xxx end")
   xxx@xxx.xxx

    xxx@xxx.xxx ActionMailer class API")
  end
  ...
  def test_new_check_mailer_syntax_from
    make_file("app/models/", "notifications.rb", "def signup\n:from xxx@xxx.xxx end")
   xxx@xxx.xxx

    assert xxx@xxx.xxx ActionMailer class API")
  end

  def test_new_check_mailer_syntax_subject
    make_file("app/models/", "notifications.rb", "def signup\n:subject xxx@xxx.xxx end")
   xxx@xxx.xxx
  ...
  def test_check_generators
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx Rails generator API")
  end
  ...
  def test_check_deprecated_cookie_finds_nothing
   xxx@xxx.xxx
    assert_equal xxx@xxx.xxx cookie secret setting")
  end
  ...
  def test_check_deprecated_cookie_settings
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx cookie secret setting")
  end

  def test_check_deprecated_session_finds_nothing
   xxx@xxx.xxx
    assert_equal xxx@xxx.xxx session secret setting")
  end
  ...
  def test_check_deprecated_session_secret
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx session secret setting")
  end
  
  def test_check_old_session_setting_finds_nothing
   xxx@xxx.xxx
    assert_equal xxx@xxx.xxx session store setting")
  end
  ...
  def test_check_deprecated_session_settings
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx session store setting")
  end
  ...
  def test_check_helpers
   ...
   xxx@xxx.xxx
    ...
    xxx@xxx.xxx ERb helper calls")
    
  end
  
  def test_check_old_helpers_lets_regular_blocks_pass
    make_file("app/views/users/", "another_test.html.erb", "<b>blah blah xxx@xxx.xxx do |item| %> <label>doo dah</label> <%= item %> <% end %>")
   xxx@xxx.xxx

    xxx@xxx.xxx ERb helper calls"), false
  end
  ...
  def test_check_old_helpers_lets_regular_blocks_pass
   ...
   xxx@xxx.xxx
    ...
    assert_equal xxx@xxx.xxx ERb helper calls")
  end

  def test_check_old_ajax_helpers
    make_file("app/views/sections", "section.js", "<%= link_to_remote 'section-', :update => 'sections', :url => {:action => :destroy, :controller => 'sections', :id xxx@xxx.xxx } %>")
   xxx@xxx.xxx

    xxx@xxx.xxx AJAX helper calls")
  end

  def test_check_old_ajax_helpers_empty
   xxx@xxx.xxx

    assert xxx@xxx.xxx AJAX helper calls")
  end
