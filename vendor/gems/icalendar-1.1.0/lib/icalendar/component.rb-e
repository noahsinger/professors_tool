...
module Icalendar
  ...
  class Component < Icalendar::Base
   ...
   xxx@xxx.xxx = {}
    ...
    def initialize(name)
     xxx@xxx.xxx = name
     xxx@xxx.xxx = Hash.new([])
     xxx@xxx.xxx = {}

      @@logger.info("New xxx@xxx.xxx
    end
    ...
    def Component.ical_component(*syms)
      hash_accessor xxx@xxx.xxx *syms
    end
